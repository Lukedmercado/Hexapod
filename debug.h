...
void CheckServoJointPos(int JointPos[]){

  for(int i = 0;i < NUM_LEGS; i++){
      Serial.print("LEG POS"); Serial.println(JointPos[i]);
}
}

void CheckAdditionalDelay(int EdgeIndex[], int total){

      Serial.println(EdgeIndex[0]);
      Serial.println(EdgeIndex[1]);
